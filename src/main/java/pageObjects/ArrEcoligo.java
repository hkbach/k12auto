...
public class ArrEcoligo {
    ...
    public String getTextStatus(int row) {
        String value = "";
        element = driver.findElement(By.xpath("//div/main/div/div[2]/div[1]/table/tbody/tr[" + row + "]/th[1]/div"));
        value = element.getText();
    ...
    public String getTextProject(int row) {
        String value = "";
        element = driver.findElement(By.xpath("//div/main/div/div[2]/div[1]/table/tbody/tr[" + row + "]/th[2]/a"));
        value = element.getText();
        if (!value.isEmpty()) {
            value = value.trim();
        }
